...
class Channel {
  ...
  Future unbind(String eventName) async {
    if (name != null) await this.pusher?._unbind(name!, eventName);
  }
  ...
  Future trigger(String eventName) async {
    ...
    if (name != null) await this.pusher?._trigger(name!, eventName);
  }
}
